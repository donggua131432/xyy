...
import com.xyy.shiro.filter.BPathMatchingFilter;
import com.xyy.shiro.token.JwtToken;
import com.xyy.util.IpUtil;
import com.xyy.util.JsonWebTokenUtil;
import com.xyy.util.RequestResponseUtil;
                ...
                if ("expiredJwt".equals(e.getMessage())) {
                    ...
                    if (null != refreshJwt && refreshJwt.equals(jwtToken)) {
                        ...
                        String newJwt = JsonWebTokenUtil.issueJWT(UUID.randomUUID().toString(),appId,
                                "asc-server", (long) (RedisKeyConstants.JWT_TTL >> 1), null,null, SignatureAlgorithm.HS512);
