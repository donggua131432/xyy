...
public class XyyRedisBean {

	private List<XyyRedisInfo> redisInfos;
	...
	public void setRedisInfos(List<XyyRedisInfo> redisInfos) {
		this.redisInfos = redisInfos;
	}
	
	public List<XyyRedisInfo> getRedisInfos() {
		return redisInfos;
	}
