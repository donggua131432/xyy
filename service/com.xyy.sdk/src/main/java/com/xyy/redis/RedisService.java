...
import com.xyy.redis.hook.RedisOpHook;
import com.xyy.serializ.FstSerializer;
import com.xyy.util.DateUtil;
...
public class RedisService {
	...
	private static XyyRedisFactory _instance = XyyRedisFactory.getInstance();

	private static Logger logger = LoggerFactory.getLogger(RedisService.class);

	private static int default_expire = 300;

	private XyyJedisPool redisPool;

	private FstSerializer fstSerialize = FstSerializer.getInstance();

	private RedisService(XyyJedisPool redisPool) {
	 ...
	 * @return
	 */
	public static RedisService newRedisService(XyyJedisPool redisPool) {
