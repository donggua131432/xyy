...
import com.xyy.domain.JwtAccount;
...
public class JsonWebTokenUtil {
     ...
     * 解析JWT的Payload
     */
    public static String parseJwtPayload(String jwtToken){
        Assert.hasText(jwtToken, "JWTTOKEN String argument cannot be null or empty.");
        ...
        if (delimiterCount != 2) {
            String msg = "JWTTOKEN strings must contain exactly 2 period characters. Found: " + delimiterCount;
        ...
        if (base64UrlEncodedPayload == null) {
            throw new MalformedJwtException("JWTTOKEN string '" + jwtToken + "' is missing a body/payload.");
        }
        // =============== Header =================
        Header header = null;
