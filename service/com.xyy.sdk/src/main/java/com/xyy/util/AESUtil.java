...
public class AESUtil {
    ...
    private static final String ENCODE_RULES = "i7Y0FEkIB6zy9JIf";
    // 偏移量
    private static final String ENCODE_IV = "M2UsytYCU4FD70y5";
    ...
    public static String aesEncode(String content, String encryptKey) {
        try {
            ...
            cipher.init(Cipher.ENCRYPT_MODE, keySpec, new IvParameterSpec(ENCODE_IV.getBytes()));
    ...
    public static String aesDecode(String content, String decryptKey) {
        try {
            ...
            cipher.init(Cipher.DECRYPT_MODE, keySpec, new IvParameterSpec(ENCODE_IV.getBytes("utf-8")));
